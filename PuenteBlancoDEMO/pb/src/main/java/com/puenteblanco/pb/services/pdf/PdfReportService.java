...
public class PdfReportService {
    ...
    public void generarPdfCitasPorFecha(
        ...
        try {
            ...
            Paragraph note = new Paragraph(
                    "Este resumen refleja la actividad registrada en el rango de fechas seleccionado.", noteFont);
                ...
                if (tipoServicio == null || tipoServicio.isBlank()) {
                    ...
                    if (dias <= 14) {
                        ...
                        agrupado = datos.stream()
                                .collect(Collectors.groupingBy(
                                        dto -> dto.getFecha()
                                                .format(DateTimeFormatter.ofPattern("MMM yyyy", new Locale("es"))),
                                        LinkedHashMap::new,
                                        Collectors.counting()));
                    }
    ...
    public void generarPdfCitasCanceladas(
        ...
        try {
            ...
            String[] headers = { "Cliente", "Mascota", "Servicio", "Veterinario", "Fecha", "Hora",
            ...
            for (CitaCanceladaDTO dto : datos) {
                ...
                table.addCell(new PdfPCell(new Phrase(dto.getFecha().toString(), cellFont)));
                table.addCell(new PdfPCell(new Phrase(dto.getHora().toString(), cellFont)));
                table.addCell(new PdfPCell(new Phrase(dto.getMotivoReprogramacion(), cellFont)));
            }
            ...
            Paragraph notaResumen = new Paragraph(
                    "Este resumen refleja únicamente las citas canceladas registradas en el sistema en el rango de fechas seleccionado.",
                    noteFont);
